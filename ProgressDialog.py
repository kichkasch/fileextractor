...
class ProgressDialog(wxDialog):
    ...
    def __init__(self, parent, ID, title, settings):
        ...
        box_current_file.Add(self.gauge_current_file, 2, wxEXPAND)
        ...
        box_overall.Add(self.gauge_overall, 2, wxEXPAND)
        ...
        box.Add(panel_current_file, 20, wxEXPAND)
        box.Add(pFill1, 1)
        box.Add(panel_overall, 20, wxEXPAND)
        box.Add(pFill2, 1)
        box.Add(self.bResultButton, 3, wxALIGN_CENTER_VERTICAL | wxALIGN_RIGHT)
        box.Add(pFill3, 1)
